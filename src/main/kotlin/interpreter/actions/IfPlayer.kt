...
import emeraldwater.infernity.dev.interpreter.IfPlayerBlock
    ...
    when (block.action) {
        IfPlayer.STANDING_ON -> {
            ...
            playerTargets.forEach { playerTarget ->
                ...
                val material =
                    playerTarget.instance.getBlock(playerTarget.position.add(0.0, -0.5, 0.0)).registry().material()
